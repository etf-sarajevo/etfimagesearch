...
{
	if (arg1 == "Color Histogram" || arg1 == "Color Moments" || arg1 == "Spatial Histogram" || arg1 == "Zhang et al." || arg1 == "HMMD quantization from CSD") {
...
ImageFeatures* NewIndexDialog::getFeatures()
{
	...
	if (featureName == "Color Histogram" || featureName == "Color Moments" || featureName == "Spatial Histogram" || featureName == "Zhang et al." || featureName == "HMMD quantization from CSD") {
